...
class FlowNet2(nn.Module):
    ...
    def forward(self, inputs):
        ...
        # scipy.misc.imsave('/home/lili/Video/flownet2-pytorch/tmp_data/img1.jpg', img1.cpu().data.numpy().transpose(1,2,0))
        # scipy.misc.imsave('/home/lili/Video/flownet2-pytorch/tmp_data/img2.jpg', img2.cpu().data.numpy().transpose(1,2,0))
